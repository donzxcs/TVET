                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    if($result) {
                                        ...
                                        <td>
                                        <button type="button" class="btn btn-success editbtn" data-bs-toggle="modal" data-bs-target="#editUserModal-'.$id.'"><i class="fas fa-edit"></i></button>
                                        <button class="btn btn-danger"><a href="delete.php?deleteid='.$id.'"
                                        class="text-light"><i class="fa-solid fa-trash"></i></a></button>
                                        </td>
                                        </tr>';
                                                    ...
                                                    <form action="process.php" method="POST">
                                                        ...
                                                        <div class="input-group"
                                                            ...
                                                            <input type="text" class="form-control" name="mname"
                                                                ...
                                                                value="<?php echo $row['name_middle']; ?>">
                                                        </div><br>
                                                        <div class="input-group"
                                                            style="border: 2px solid; padding: 1px;">
                                                            <div class="input-group-text bg-primary text-white">
                                                            ...
                                                            <input type="text" class="form-control" name="lname"
                                                                ...
                                                                value="<?php echo $row['name_family']; ?>">
                                                        </div><br>
                                                        <div class="input-group"
                                                            style="border: 2px solid; padding: 1px;">
                                                            <div class="input-group-text bg-primary text-white">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <input type="submit" name="update"
                                                                class="btn btn-success btn-lg" value="Save UpdateA">
                                                        </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <!-- Kung may iban ka pa nga modal karonparehos sang Delete. Diri mo lang isalpak. Antis mag-close ang loop -->
                                    <?php 
                                        } //closing sang loop               
                                    }
                                ?>
