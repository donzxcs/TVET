                ...
                <div class="container-fluid">
                    ...
                    <div class="card border-0">
                        <div class="card-header">
                            <h5 class="card-title">
                                List of Borrowed System Units<button type="submit" class="btn btn-primary" style="float:right;" data-bs-toggle="modal" data-bs-target="#add">Audit Action</button>
                        ...
                        <div class="modal-dialog">
                            ...
                            <input type="hidden" name="transacid"
                                value="<?php echo $row['transac_id']; ?>">

                            <input type="hidden" name="userID"
                            value="<?php echo $loggedInID; ?>">
                            <!--<div class="mb-3">
                            <label class="form-label">Transaction Code</label>
                                        <input type="text" class="form-control" name="codeTransac" placeholder="Enter Your Transaction Code" required></p>
                                    </div>-->
                                    <div class="mb-1">
                                ...
                                <div class="modal-footer" style="justify-content: flex-end;">
                                    ...
                                    <button type="submit" class="btn btn-primary" name="changeAudit">Submit</button>
                                </div>
                            </form>
                                    </div>
                            </div>
